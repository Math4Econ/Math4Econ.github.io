...
% curves by solving for quantities demanded and supplied at many prices points 
% and connecting the resulting pairs of price and quantity demanded and supplied 
% in a graph together.
