...
% maximization problem from <https://math4econ.github.io/matrix_application/KL_borrowhire_firm.html 
...
% unconstrained capital and labor choices we found previously in <https://math4econ.github.io/matrix_application/KL_borrowhire_firm.html 
% Firm's Profit Maximization Problem with Cobb Douglas Production Function (Decreasing 
% Returns to Scale)>.
...
% in <https://math4econ.github.io/derivative_application/K_borrow_firm.html Firm's 
% Profit Maximization Problem and Optimal Capital Choice>, except there we solve 
% for optimal capital fixing labor. Now we need to solve for optimal labor fixing 
% capital at the constraint. 
%% Solution
