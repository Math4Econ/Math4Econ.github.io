...
% * $b\ge \bar{b}$
%% 
% $\bar{b}$ is the borrowing limit. Note that because $b$ is negative when we 
% are borrowing, so a higher upper bound on how much you can borrow is represented 
...
% order condition that we had from the <https://math4econ.github.io/derivative_application/K_save_households.html 
